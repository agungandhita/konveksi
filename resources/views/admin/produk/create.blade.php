...
<div class="max-w-4xl mx-auto mt-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Tambahkan produk baru ke katalog</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi_singkat" id="deskripsi_singkat" rows="3"
                                  ...
                                  placeholder="Masukkan deskripsi singkat produk (opsional)">{{ old('deskripsi_singkat') }}</textarea>
