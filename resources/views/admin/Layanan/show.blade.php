...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @if(session('success'))
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 text-green-800 px-6 py-4 rounded-xl mb-6 relative shadow-lg animate-slide-down" role="alert">
            <div class="flex items-center">
                ...
                <button type="button" class="absolute top-0 right-0 mt-4 mr-4 text-green-600 hover:text-green-800 transition-colors duration-200" onclick="this.parentElement.style.display='none'">
    ...
    @if(session('error'))
        <div class="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 text-red-800 px-6 py-4 rounded-xl mb-6 relative shadow-lg animate-slide-down" role="alert">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                ...
                <button type="button" class="absolute top-0 right-0 mt-4 mr-4 text-red-600 hover:text-red-800 transition-colors duration-200" onclick="this.parentElement.style.display='none'">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                </button>
